// Состояние плеера хранится в React Context.
// Благодаря этому данные о текущем треке, воспроизведении,
// громкости и прогрессе доступны разным компонентам приложения
// без необходимости передавать их через большое количество промежуточных компонентов.
import {
  createContext,
  useCallback,
  useContext,
